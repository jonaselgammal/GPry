...
from gpry.kernels_sklearn import RBF, Matern, ConstantKernel as C
from gpry.kernels_jax import (
    _rbf_kernel_matrix,
    _matern52_kernel_matrix,
    _matern32_kernel_matrix,
    _matern12_kernel_matrix,
)
from gpry.gpr_jax_linalg import (
...
class TestJaxGaussianProcessMixin:
    """Test the internal JAX GP mixin against GPry's GaussianProcessRegressor."""
